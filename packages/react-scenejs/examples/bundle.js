...
/***/ "./node_modules/scenejs/dist/esm/Animator.js":
/*!***************************************************!*\
  !*** ./node_modules/scenejs/dist/esm/Animator.js ***!
  \***************************************************/
/*! exports provided: isDirectionReverse, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "isDirectionReverse", function() { return isDirectionReverse; });
/* harmony import */ var _consts__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./consts */ "./node_modules/scenejs/dist/esm/consts.js");
/* harmony import */ var _EventTrigger__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./EventTrigger */ "./node_modules/scenejs/dist/esm/EventTrigger.js");
/* harmony import */ var _easing__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./easing */ "./node_modules/scenejs/dist/esm/easing.js");
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./utils */ "./node_modules/scenejs/dist/esm/utils.js");
    ...
    */
    Animator.prototype.setEasing = function (curveArray) {
        this.setState(Array.isArray(curveArray) ? {
            ...
            easing: Object(_easing__WEBPACK_IMPORTED_MODULE_2__["bezier"])(curveArray[0], curveArray[1], curveArray[2], curveArray[3])
        } : {
            easing: curveArray,
...
animator.getTime();
    */
    ...
    Animator.prototype.getUnitTime = function (time) {
        if (Object(_utils__WEBPACK_IMPORTED_MODULE_3__["isString"])(time)) {
            ...
            var _a = Object(_utils__WEBPACK_IMPORTED_MODULE_3__["splitUnit"])(time), unit = _a.unit, value = _a.value;
            if (unit === "%") {
                !this.getDuration() && (this.state.duration = duration);
                return parseFloat(time) / 100 * duration;
            }
            else if (unit === ">") {
                return value + _consts__WEBPACK_IMPORTED_MODULE_0__["THRESHOLD"];
            }
            else {
                return value;
            }
            ...
            return Object(_utils__WEBPACK_IMPORTED_MODULE_3__["toFixed"])(time);
        }
    };
    /**
...
animator.getIterationTime();
    */
    ...
    return Animator;
}(_EventTrigger__WEBPACK_IMPORTED_MODULE_1__["default"]));
/* harmony default export */ __webpack_exports__["default"] = (Animator);


/***/ }),

/***/ "./node_modules/scenejs/dist/esm/EventTrigger.js":
/*!*******************************************************!*\
  !*** ./node_modules/scenejs/dist/esm/EventTrigger.js ***!
  \*******************************************************/
...
/***/ "./node_modules/scenejs/dist/esm/Frame.js":
/*!************************************************!*\
  !*** ./node_modules/scenejs/dist/esm/Frame.js ***!
  \************************************************/
/*! exports provided: default */
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _consts__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./consts */ "./node_modules/scenejs/dist/esm/consts.js");
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./utils */ "./node_modules/scenejs/dist/esm/utils.js");
/* harmony import */ var _utils_property__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./utils/property */ "./node_modules/scenejs/dist/esm/utils/property.js");
/* harmony import */ var _PropertyObject__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./PropertyObject */ "./node_modules/scenejs/dist/esm/PropertyObject.js");
...
function isPropertyObject(value) {
    return value instanceof _PropertyObject__WEBPACK_IMPORTED_MODULE_3__["default"];
}
/* eslint-disable */
...
function merge(to, from, toValue) {
    ...
    for (var name_2 in from) {
        ...
        var type = Object(_utils__WEBPACK_IMPORTED_MODULE_1__["getType"])(value);
        if (type === "property") {
            ...
            if (Object(_utils__WEBPACK_IMPORTED_MODULE_1__["isObject"])(to[name_2]) && !(to[name_2] instanceof _PropertyObject__WEBPACK_IMPORTED_MODULE_3__["default"])) {
...
var Frame = /*#__PURE__*/ (function () {
    ...
    */
    ...
    Frame.prototype.raw = function () {
        ...
        var params = args[0] in _consts__WEBPACK_IMPORTED_MODULE_0__["ALIAS"] ? _consts__WEBPACK_IMPORTED_MODULE_0__["ALIAS"][args[0]] : args;
        var length = params.length;
        for (var i = 0; i < length; ++i) {
            if (!Object(_utils__WEBPACK_IMPORTED_MODULE_1__["isObject"])(properties)) {
                return undefined;
            }
...
frame.set("transform", "translate", "50px");
    */
    Frame.prototype.set = function () {
        ...
        if (params[0] in _consts__WEBPACK_IMPORTED_MODULE_0__["ALIAS"]) {
            this._set(_consts__WEBPACK_IMPORTED_MODULE_0__["ALIAS"][params[0]], value);
        }
        else if (length === 2 && Object(_utils__WEBPACK_IMPORTED_MODULE_1__["isArray"])(params[0])) {
            ...
            if (Object(_utils__WEBPACK_IMPORTED_MODULE_1__["isArray"])(value)) {
                ...
                if (Object(_utils__WEBPACK_IMPORTED_MODULE_1__["isRole"])(params)) {
                    this.set.apply(this, params.concat([Object(_utils_property__WEBPACK_IMPORTED_MODULE_2__["toObject"])(value)]));
                }
                else {
                    this._set(params, value);
                }
        ...
        else if (Object(_utils__WEBPACK_IMPORTED_MODULE_1__["isString"])(value)) {
            if (Object(_utils__WEBPACK_IMPORTED_MODULE_1__["isRole"])(params)) {
                var obj = Object(_utils_property__WEBPACK_IMPORTED_MODULE_2__["toPropertyObject"])(value);
                if (Object(_utils__WEBPACK_IMPORTED_MODULE_1__["isObject"])(obj)) {
                    this.set.apply(this, params.concat([obj]));
                }
                return this;
            }
            else {
                var styles = Object(_utils_property__WEBPACK_IMPORTED_MODULE_2__["splitStyle"])(value);
    ...
    */
    Frame.prototype.has = function () {
        ...
        for (var i = 0; i < length; ++i) {
            if (!Object(_utils__WEBPACK_IMPORTED_MODULE_1__["isObject"])(properties) || !(params[i] in properties)) {
                return false;
            }
            properties = properties[params[i]];
        }
    ...
    */
    Frame.prototype.toCSSObject = function () {
        ...
        for (var name_4 in properties) {
            if (Object(_utils__WEBPACK_IMPORTED_MODULE_1__["isRole"])([name_4], true)) {
                continue;
            }
            var value = properties[name_4];
            if (name_4 === _consts__WEBPACK_IMPORTED_MODULE_0__["timingFunction"]) {
                cssObject[_consts__WEBPACK_IMPORTED_MODULE_0__["timingFunction"].replace("animation", _consts__WEBPACK_IMPORTED_MODULE_0__["ANIMATION"])] =
                    (Object(_utils__WEBPACK_IMPORTED_MODULE_1__["isString"])(value) ? value : value.easingName) || "initial";
                continue;
            }
        ...
        _consts__WEBPACK_IMPORTED_MODULE_0__["TRANSFORM"] && transform && (cssObject[_consts__WEBPACK_IMPORTED_MODULE_0__["TRANSFORM"]] = transform);
        _consts__WEBPACK_IMPORTED_MODULE_0__["FILTER"] && filter && (cssObject[_consts__WEBPACK_IMPORTED_MODULE_0__["FILTER"]] = filter);
        return cssObject;
    };
    /**
    ...
    */
    ...
    Frame.prototype._set = function (args, value) {
        ...
        properties[args[length - 1]] = Object(_utils__WEBPACK_IMPORTED_MODULE_1__["isString"])(value) ? Object(_utils_property__WEBPACK_IMPORTED_MODULE_2__["toPropertyObject"])(value) : value;
    };
    return Frame;
}());
...
/***/ "./node_modules/scenejs/dist/esm/Keyframes.js":
/*!****************************************************!*\
  !*** ./node_modules/scenejs/dist/esm/Keyframes.js ***!
  \****************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./utils */ "./node_modules/scenejs/dist/esm/utils.js");
/* harmony import */ var _PropertyObject__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./PropertyObject */ "./node_modules/scenejs/dist/esm/PropertyObject.js");
...
function getNames(names, stack) {
    ...
    for (var name_1 in names) {
        stack.push(name_1);
        if (Object(_utils__WEBPACK_IMPORTED_MODULE_0__["isObject"])(names[name_1])) {
...
function updateFrame(names, properties) {
    for (var name_2 in properties) {
        ...
        if (!Object(_utils__WEBPACK_IMPORTED_MODULE_0__["isObject"])(value) || Object(_utils__WEBPACK_IMPORTED_MODULE_0__["isArray"])(value) || value instanceof _PropertyObject__WEBPACK_IMPORTED_MODULE_1__["default"]) {
            names[name_2] = true;
            continue;
        }
        if (!Object(_utils__WEBPACK_IMPORTED_MODULE_0__["isObject"])(names[name_2])) {
            names[name_2] = {};
        }
...
keyframes.hasName("transform", "translate"); // true or not
    */
    Keyframes.prototype.hasName = function () {
        ...
        return Object(_utils__WEBPACK_IMPORTED_MODULE_0__["isInProperties"])(this.names, args, true);
    };
    /**
    ...
    */
    ...
    Keyframes.prototype.unshift = function (time) {
        ...
        this.times = times.map(function (t) {
            var time2 = Object(_utils__WEBPACK_IMPORTED_MODULE_0__["toFixed"])(time + t);
            obj[time2] = items[t];
            return time2;
        });
        this.items = obj;
...
/***/ "./node_modules/scenejs/dist/esm/PropertyObject.js":
/*!*********************************************************!*\
  !*** ./node_modules/scenejs/dist/esm/PropertyObject.js ***!
  \*********************************************************/
/*! exports provided: default */
...
/* harmony default export */ __webpack_exports__["default"] = (PropertyObject);


/***/ }),

/***/ "./node_modules/scenejs/dist/esm/Scene.js":
/*!************************************************!*\
  !*** ./node_modules/scenejs/dist/esm/Scene.js ***!
  \************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _Animator__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Animator */ "./node_modules/scenejs/dist/esm/Animator.js");
/* harmony import */ var _SceneItem__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./SceneItem */ "./node_modules/scenejs/dist/esm/SceneItem.js");
/* harmony import */ var _consts__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./consts */ "./node_modules/scenejs/dist/esm/consts.js");
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./utils */ "./node_modules/scenejs/dist/esm/utils.js");
var __extends = (undefined && undefined.__extends) || (function () {
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
...
const item = scene.newItem("item1")
    */
    Scene.prototype.newItem = function (name, options) {
        if (options === void 0) { options = {}; }
        if (Object(_utils__WEBPACK_IMPORTED_MODULE_3__["has"])(this.items, name)) {
            return this.items[name];
        }
        var item = new _SceneItem__WEBPACK_IMPORTED_MODULE_1__["default"]();
...
const item = scene.newItem("item1")
    */
    Scene.prototype.setItem = function (name, item) {
        if (item instanceof _Animator__WEBPACK_IMPORTED_MODULE_0__["default"]) {
            item.setId(name);
        }
...
scene.playCSS(false, {
    ...
    */
    Scene.prototype.playCSS = function (exportCSS, properties) {
        ...
        if (properties === void 0) { properties = {}; }
        if (!_consts__WEBPACK_IMPORTED_MODULE_2__["ANIMATION"] || this.getPlayState() === "running") {
            return this;
        }
    ...
    Scene.prototype.load = function (properties, options) {
        ...
        for (var name_2 in properties) {
            ...
            var item = void 0;
            if (object instanceof Scene || object instanceof _SceneItem__WEBPACK_IMPORTED_MODULE_1__["default"]) {
...
/***/ "./node_modules/scenejs/dist/esm/SceneItem.js":
/*!****************************************************!*\
  !*** ./node_modules/scenejs/dist/esm/SceneItem.js ***!
  \****************************************************/
/*! exports provided: default */
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _Animator__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Animator */ "./node_modules/scenejs/dist/esm/Animator.js");
/* harmony import */ var _Frame__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Frame */ "./node_modules/scenejs/dist/esm/Frame.js");
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./utils */ "./node_modules/scenejs/dist/esm/utils.js");
/* harmony import */ var _Keyframes__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./Keyframes */ "./node_modules/scenejs/dist/esm/Keyframes.js");
/* harmony import */ var _utils_dot__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./utils/dot */ "./node_modules/scenejs/dist/esm/utils/dot.js");
/* harmony import */ var _consts__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./consts */ "./node_modules/scenejs/dist/esm/consts.js");
/* harmony import */ var _utils_css__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./utils/css */ "./node_modules/scenejs/dist/esm/utils/css.js");
var __extends = (undefined && undefined.__extends) || (function () {
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
            ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
...
function makeAnimationProperties(properties) {
    ...
    for (var name_1 in properties) {
        cssArray.push(_consts__WEBPACK_IMPORTED_MODULE_5__["ANIMATION"] + "-" + Object(_utils__WEBPACK_IMPORTED_MODULE_2__["decamelize"])(name_1) + " : " + properties[name_1] + ";");
    }
    return cssArray.join("");
}
/**
...
var SceneItem = /*#__PURE__*/ (function (_super) {
    ...
    * @example
    ...
    function SceneItem(properties, options) {
        var _this = _super.call(this) || this;
        _this.keyframes = new _Keyframes__WEBPACK_IMPORTED_MODULE_3__["default"]();
        _this.elements = [];
        _this.load(properties, options);
        return _this;
    }
    ...
    SceneItem.prototype.setDuration = function (duration) {
        ...
        _super.prototype.setDuration.call(this, Object(_utils__WEBPACK_IMPORTED_MODULE_2__["toFixed"])(duration));
        return this;
    };
    /**
...
console.log(item.get(0, "a")); // "b"
    */
    SceneItem.prototype.set = function (time) {
        ...
        if (Object(_utils__WEBPACK_IMPORTED_MODULE_2__["isObject"])(time)) {
            this.load(time);
            return this;
        }
        else if (args[0]) {
            ...
            else if (args.length === 1 && Object(_utils__WEBPACK_IMPORTED_MODULE_2__["isArray"])(args[0])) {
    ...
    */
    SceneItem.prototype.prepend = function (item) {
        if (item instanceof SceneItem) {
            ...
            this.set(0, item);
            this.set(unshiftTime + _consts__WEBPACK_IMPORTED_MODULE_5__["THRESHOLD"], firstFrame);
        }
        else {
...
item.setCSS(0, ["opacity", "width", "height"]);
    */
    SceneItem.prototype.setCSS = function (time, properties) {
        this.set(time, Object(_utils_css__WEBPACK_IMPORTED_MODULE_6__["fromCSS"])(this.elements, properties));
        return this;
    };
...
item.newFrame(time);
    */
    SceneItem.prototype.newFrame = function (time) {
        ...
        frame = new _Frame__WEBPACK_IMPORTED_MODULE_1__["default"]();
...
item.copyFrame(0, 1);
    */
    SceneItem.prototype.copyFrame = function (fromTime, toTime) {
        if (Object(_utils__WEBPACK_IMPORTED_MODULE_2__["isObject"])(fromTime)) {
    ...
    */
    SceneItem.prototype.getNowFrame = function (time, easing) {
        ...
        names.forEach(function (properties) {
            ...
            if (Object(_utils__WEBPACK_IMPORTED_MODULE_2__["isUndefined"])(value)) {
                return;
            }
    ...
    SceneItem.prototype.load = function (properties, options) {
        if (properties === void 0) { properties = {}; }
        if (options === void 0) { options = properties.options; }
        if (Object(_utils__WEBPACK_IMPORTED_MODULE_2__["isArray"])(properties)) {
    ...
    SceneItem.prototype.getAllTimes = function (isStartZero, options) {
        ...
        for (var i = 0; i < iterationCount; ++i) {
            var isReverse = Object(_Animator__WEBPACK_IMPORTED_MODULE_0__["isDirectionReverse"])(i, direction);
            ...
            for (var j = 0; j < length; ++j) {
                ...
                var threshold = j === 0 && (i === 0 ? !isStartZero : !isShuffle) ? _consts__WEBPACK_IMPORTED_MODULE_5__["THRESHOLD"] : 0;
                var keyvalue = isReverse ? times[length - 1 - j] : times[j];
                var time = Object(_utils__WEBPACK_IMPORTED_MODULE_2__["toFixed"])(isReverse ? duration - keyvalue : keyvalue);
                var keytime = Object(_utils__WEBPACK_IMPORTED_MODULE_2__["toFixed"])(start + time + threshold);
        ...
        if (keys[keys.length - 1] < totalDuration) {
            ...
            var isReverse = Object(_Animator__WEBPACK_IMPORTED_MODULE_0__["isDirectionReverse"])(iterationCount, direction);
            var keyvalue = Object(_utils__WEBPACK_IMPORTED_MODULE_2__["toFixed"])(duration * (isReverse ? 1 - iterationCount % 1 : iterationCount % 1));
    ...
    */
    SceneItem.prototype.toCSS = function (duration, options) {
        ...
        var cssText = makeAnimationProperties({
            ...
            direction: direction,
            delay: delay + "s",
            name: _consts__WEBPACK_IMPORTED_MODULE_5__["PREFIX"] + "KEYFRAMES_" + toId(id),
            duration: duration / playSpeed + "s",
            timingFunction: easingName,
            iterationCount: count
        });
        var css = selector + "." + _consts__WEBPACK_IMPORTED_MODULE_5__["START_ANIMATION"] + " {\n\t\t\t" + cssText + "\n\t\t}\n\t\t" + this._toKeyframes(duration, options);
        return css;
    };
    SceneItem.prototype.exportCSS = function (duration, options) {
        ...
        var id = this._getId();
        var styleElement = document.querySelector("#" + _consts__WEBPACK_IMPORTED_MODULE_5__["PREFIX"] + id);
        var css = this.toCSS(duration, options);
        if (styleElement) {
            styleElement.innerText = css;
        }
        else {
            document.body.insertAdjacentHTML("beforeend", "<style id=\"" + _consts__WEBPACK_IMPORTED_MODULE_5__["PREFIX"] + "STYLE_" + id + "\">" + css + "</style>");
        }
    };
    /**
    * Play using the css animation and keyframes.
...
item.playCSS(false, {
    ...
    */
    SceneItem.prototype.playCSS = function (exportCSS, properties) {
        ...
        if (exportCSS === void 0) { exportCSS = true; }
        if (properties === void 0) { properties = {}; }
        if (!_consts__WEBPACK_IMPORTED_MODULE_5__["ANIMATION"] || this.getPlayState() === "running") {
            return this;
        }
        var elements = this.elements;
        var length = elements.length;
        ...
        for (var i = 0; i < length; ++i) {
            ...
            if (Object(_utils_css__WEBPACK_IMPORTED_MODULE_6__["hasClass"])(element, _consts__WEBPACK_IMPORTED_MODULE_5__["START_ANIMATION"])) {
                Object(_utils_css__WEBPACK_IMPORTED_MODULE_6__["removeClass"])(element, _consts__WEBPACK_IMPORTED_MODULE_5__["START_ANIMATION"]);
                (function (el) {
                    requestAnimationFrame(function () {
                        requestAnimationFrame(function () {
                            Object(_utils_css__WEBPACK_IMPORTED_MODULE_6__["addClass"])(el, _consts__WEBPACK_IMPORTED_MODULE_5__["START_ANIMATION"]);
                        });
                    });
                })(element);
            }
            else {
                Object(_utils_css__WEBPACK_IMPORTED_MODULE_6__["addClass"])(element, _consts__WEBPACK_IMPORTED_MODULE_5__["START_ANIMATION"]);
            }
        }
        this.setState({ playCSS: true });
        this.setPlayState("running");
    ...
    SceneItem.prototype._getEasing = function (time, left, right, easing) {
        if (this.keyframes.hasName(_consts__WEBPACK_IMPORTED_MODULE_5__["timingFunction"])) {
            var nowEasing = this._getNowValue(time, left, right, [_consts__WEBPACK_IMPORTED_MODULE_5__["timingFunction"]], 0, true);
    ...
    SceneItem.prototype._toKeyframes = function (duration, options) {
        ...
        return "@" + _consts__WEBPACK_IMPORTED_MODULE_5__["KEYFRAMES"] + " " + _consts__WEBPACK_IMPORTED_MODULE_5__["PREFIX"] + "KEYFRAMES_" + toId(id) + "{\n\t\t\t" + keyframes.join("\n") + "\n\t\t}";
    };
    SceneItem.prototype._getNowValue = function (time, left, right, properties, easing, usePrevValue) {
        ...
        if (usePrevValue === void 0) { usePrevValue = Object(_utils__WEBPACK_IMPORTED_MODULE_2__["isFixed"])(properties); }
        var keyframes = this.keyframes;
        ...
        if (!prevFrame || Object(_utils__WEBPACK_IMPORTED_MODULE_2__["isUndefined"])(prevValue)) {
            return nextValue;
        }
        if (!nextFrame || Object(_utils__WEBPACK_IMPORTED_MODULE_2__["isUndefined"])(nextValue) || prevValue === nextValue) {
            return prevValue;
        }
        if (prevTime < 0) {
            prevTime = 0;
        }
        return Object(_utils_dot__WEBPACK_IMPORTED_MODULE_4__["dotValue"])(time, prevTime, nextTime, prevValue, nextValue, easing);
    };
...
/* harmony default export */ __webpack_exports__["default"] = (SceneItem);


/***/ }),

/***/ "./node_modules/scenejs/dist/esm/consts.js":
/*!*************************************************!*\
  !*** ./node_modules/scenejs/dist/esm/consts.js ***!
  \*************************************************/
/*! exports provided: PREFIX, timingFunction, ROLES, ALIAS, FIXED, MAXIMUM, THRESHOLD, OPTIONS, EVENTS, TRANSFORM, FILTER, ANIMATION, KEYFRAMES, START_ANIMATION */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "START_ANIMATION", function() { return START_ANIMATION; });
...
/***/ "./node_modules/scenejs/dist/esm/easing.js":
/*!*************************************************!*\
  !*** ./node_modules/scenejs/dist/esm/easing.js ***!
  \*************************************************/
/*! exports provided: bezier, LINEAR, EASE, EASE_IN, EASE_OUT, EASE_IN_OUT */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
*/
var EASE_OUT = bezier(0, 0, 0.58, 1);
/**
...
*/
var EASE_IN_OUT = bezier(0.42, 0, 0.58, 1);


/***/ }),

/***/ "./node_modules/scenejs/dist/esm/index.js":
/*!************************************************!*\
  !*** ./node_modules/scenejs/dist/esm/index.js ***!
  \************************************************/
/*! exports provided: VERSION, SceneItem, Frame, Animator, Keyframes, PropertyObject, easing, presets, OPTIONS, EVENTS, setRole, setAlias, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "VERSION", function() { return VERSION; });
/* harmony import */ var _Scene__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Scene */ "./node_modules/scenejs/dist/esm/Scene.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "default", function() { return _Scene__WEBPACK_IMPORTED_MODULE_0__["default"]; });

/* harmony import */ var _SceneItem__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./SceneItem */ "./node_modules/scenejs/dist/esm/SceneItem.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "SceneItem", function() { return _SceneItem__WEBPACK_IMPORTED_MODULE_1__["default"]; });

/* harmony import */ var _Frame__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Frame */ "./node_modules/scenejs/dist/esm/Frame.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "Frame", function() { return _Frame__WEBPACK_IMPORTED_MODULE_2__["default"]; });

/* harmony import */ var _Keyframes__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./Keyframes */ "./node_modules/scenejs/dist/esm/Keyframes.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "Keyframes", function() { return _Keyframes__WEBPACK_IMPORTED_MODULE_3__["default"]; });

/* harmony import */ var _PropertyObject__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./PropertyObject */ "./node_modules/scenejs/dist/esm/PropertyObject.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "PropertyObject", function() { return _PropertyObject__WEBPACK_IMPORTED_MODULE_4__["default"]; });

/* harmony import */ var _easing__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./easing */ "./node_modules/scenejs/dist/esm/easing.js");
/* harmony reexport (module object) */ __webpack_require__.d(__webpack_exports__, "easing", function() { return _easing__WEBPACK_IMPORTED_MODULE_5__; });
/* harmony import */ var _Animator__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./Animator */ "./node_modules/scenejs/dist/esm/Animator.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "Animator", function() { return _Animator__WEBPACK_IMPORTED_MODULE_6__["default"]; });

/* harmony import */ var _presets_index__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./presets/index */ "./node_modules/scenejs/dist/esm/presets/index.js");
/* harmony reexport (module object) */ __webpack_require__.d(__webpack_exports__, "presets", function() { return _presets_index__WEBPACK_IMPORTED_MODULE_7__; });
/* harmony import */ var _consts__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./consts */ "./node_modules/scenejs/dist/esm/consts.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "OPTIONS", function() { return _consts__WEBPACK_IMPORTED_MODULE_8__["OPTIONS"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "EVENTS", function() { return _consts__WEBPACK_IMPORTED_MODULE_8__["EVENTS"]; });

/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./utils */ "./node_modules/scenejs/dist/esm/utils.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "setRole", function() { return _utils__WEBPACK_IMPORTED_MODULE_9__["setRole"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "setAlias", function() { return _utils__WEBPACK_IMPORTED_MODULE_9__["setAlias"]; });
...
/***/ "./node_modules/scenejs/dist/esm/presets/blink.js":
/*!********************************************************!*\
  !*** ./node_modules/scenejs/dist/esm/presets/blink.js ***!
  \********************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return blink; });
/* harmony import */ var _set__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./set */ "./node_modules/scenejs/dist/esm/presets/set.js");
...
function blink(_a) {
    ...
    return Object(_set__WEBPACK_IMPORTED_MODULE_0__["default"])("opacity", [from, to, from], arguments[0]);
}


/***/ }),

/***/ "./node_modules/scenejs/dist/esm/presets/fadeIn.js":
/*!*********************************************************!*\
  !*** ./node_modules/scenejs/dist/esm/presets/fadeIn.js ***!
  \*********************************************************/
/*! exports provided: default */
...
function fadeIn(_a) {
    var _b = _a.from, from = _b === void 0 ? 0 : _b, _c = _a.to, to = _c === void 0 ? 1 : _c;
    return Object(_set__WEBPACK_IMPORTED_MODULE_0__["default"])("opacity", [from, to], arguments[0]);
}


/***/ }),

/***/ "./node_modules/scenejs/dist/esm/presets/fadeOut.js":
/*!**********************************************************!*\
  !*** ./node_modules/scenejs/dist/esm/presets/fadeOut.js ***!
  \**********************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return fadeOut; });
/* harmony import */ var _set__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./set */ "./node_modules/scenejs/dist/esm/presets/set.js");
...
/***/ "./node_modules/scenejs/dist/esm/presets/index.js":
/*!********************************************************!*\
  !*** ./node_modules/scenejs/dist/esm/presets/index.js ***!
  \********************************************************/
/*! exports provided: blink, fadeIn, fadeOut, wipeIn, wipeOut, zoomIn, zoomOut, set, transition */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _blink__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./blink */ "./node_modules/scenejs/dist/esm/presets/blink.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "blink", function() { return _blink__WEBPACK_IMPORTED_MODULE_0__["default"]; });

/* harmony import */ var _fadeIn__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./fadeIn */ "./node_modules/scenejs/dist/esm/presets/fadeIn.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "fadeIn", function() { return _fadeIn__WEBPACK_IMPORTED_MODULE_1__["default"]; });

/* harmony import */ var _fadeOut__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./fadeOut */ "./node_modules/scenejs/dist/esm/presets/fadeOut.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "fadeOut", function() { return _fadeOut__WEBPACK_IMPORTED_MODULE_2__["default"]; });

/* harmony import */ var _wipeIn__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./wipeIn */ "./node_modules/scenejs/dist/esm/presets/wipeIn.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "wipeIn", function() { return _wipeIn__WEBPACK_IMPORTED_MODULE_3__["default"]; });

/* harmony import */ var _wipeOut__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./wipeOut */ "./node_modules/scenejs/dist/esm/presets/wipeOut.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "wipeOut", function() { return _wipeOut__WEBPACK_IMPORTED_MODULE_4__["default"]; });

/* harmony import */ var _zoomIn__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./zoomIn */ "./node_modules/scenejs/dist/esm/presets/zoomIn.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "zoomIn", function() { return _zoomIn__WEBPACK_IMPORTED_MODULE_5__["default"]; });

/* harmony import */ var _zoomOut__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./zoomOut */ "./node_modules/scenejs/dist/esm/presets/zoomOut.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "zoomOut", function() { return _zoomOut__WEBPACK_IMPORTED_MODULE_6__["default"]; });

/* harmony import */ var _set__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./set */ "./node_modules/scenejs/dist/esm/presets/set.js");
...
/* harmony import */ var _transition__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./transition */ "./node_modules/scenejs/dist/esm/presets/transition.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "transition", function() { return _transition__WEBPACK_IMPORTED_MODULE_8__["default"]; });
...
/**
 * @namespace Scene.presets
 * @example
 * // <script src="http://daybrush.github.io/scenejs/release/latest/scene.presets.js"></script>
  * // import {presets} from "scenejs";
...
/***/ "./node_modules/scenejs/dist/esm/presets/set.js":
/*!******************************************************!*\
  !*** ./node_modules/scenejs/dist/esm/presets/set.js ***!
  \******************************************************/
/*! exports provided: default */
...
/* harmony import */ var _index__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../index */ "./node_modules/scenejs/dist/esm/index.js");
...
function set(property, values, options) {
    var item = new _index__WEBPACK_IMPORTED_MODULE_0__["SceneItem"]({}, options);
...
/***/ "./node_modules/scenejs/dist/esm/presets/transition.js":
/*!*************************************************************!*\
  !*** ./node_modules/scenejs/dist/esm/presets/transition.js ***!
  \*************************************************************/
/*! exports provided: default */
...
/***/ "./node_modules/scenejs/dist/esm/presets/wipeIn.js":
/*!*********************************************************!*\
  !*** ./node_modules/scenejs/dist/esm/presets/wipeIn.js ***!
  \*********************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return wipeIn; });
/* harmony import */ var _set__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./set */ "./node_modules/scenejs/dist/esm/presets/set.js");
...
function wipeIn(_a) {
    ...
    return Object(_set__WEBPACK_IMPORTED_MODULE_0__["default"])(property, [from, to], arguments[0]);
}


/***/ }),

/***/ "./node_modules/scenejs/dist/esm/presets/wipeOut.js":
/*!**********************************************************!*\
  !*** ./node_modules/scenejs/dist/esm/presets/wipeOut.js ***!
  \**********************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return wipeOut; });
/* harmony import */ var _set__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./set */ "./node_modules/scenejs/dist/esm/presets/set.js");
...
/***/ "./node_modules/scenejs/dist/esm/presets/zoomIn.js":
/*!*********************************************************!*\
  !*** ./node_modules/scenejs/dist/esm/presets/zoomIn.js ***!
  \*********************************************************/
/*! exports provided: default */
...
function zoomIn(_a) {
    var _b = _a.from, from = _b === void 0 ? 0 : _b, _c = _a.to, to = _c === void 0 ? 1 : _c;
    return Object(_set__WEBPACK_IMPORTED_MODULE_0__["default"])(["transform", "scale"], [from, to], arguments[0]);
}


/***/ }),

/***/ "./node_modules/scenejs/dist/esm/presets/zoomOut.js":
/*!**********************************************************!*\
  !*** ./node_modules/scenejs/dist/esm/presets/zoomOut.js ***!
  \**********************************************************/
/*! exports provided: default */
...
/***/ "./node_modules/scenejs/dist/esm/utils.js":
/*!************************************************!*\
  !*** ./node_modules/scenejs/dist/esm/utils.js ***!
  \************************************************/
/*! exports provided: setAlias, setRole, getType, toFixed, isInProperties, isRole, isFixed, isUndefined, isObject, isArray, isString, has, splitUnit, decamelize */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "isInProperties", function() { return isInProperties; });
...
function setAlias(name, alias) {
    _consts__WEBPACK_IMPORTED_MODULE_0__["ALIAS"][name] = alias;
}
function setRole(names, isProperty, isFixedProperty) {
    var length = names.length;
    var roles = _consts__WEBPACK_IMPORTED_MODULE_0__["ROLES"];
    var fixed = _consts__WEBPACK_IMPORTED_MODULE_0__["FIXED"];
    for (var i = 0; i < length - 1; ++i) {
...
function getType(value) {
    ...
    if (type === "object") {
        ...
        else if (value instanceof _PropertyObject__WEBPACK_IMPORTED_MODULE_1__["default"]) {
            return "property";
        }
    }
...
function toFixed(num) {
    return Math.round(num * _consts__WEBPACK_IMPORTED_MODULE_0__["MAXIMUM"]) / _consts__WEBPACK_IMPORTED_MODULE_0__["MAXIMUM"];
}
...
function isRole(args, isCheckTrue) {
    return isInProperties(_consts__WEBPACK_IMPORTED_MODULE_0__["ROLES"], args, isCheckTrue);
}
function isFixed(args) {
    return isInProperties(_consts__WEBPACK_IMPORTED_MODULE_0__["FIXED"], args, true);
}
...
/***/ "./node_modules/scenejs/dist/esm/utils/color.js":
/*!******************************************************!*\
  !*** ./node_modules/scenejs/dist/esm/utils/color.js ***!
  \******************************************************/
/*! exports provided: COLOR_MODELS, cutHex, hexToRGB, hex3to6, hslToRGB */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "hex3to6", function() { return hex3to6; });
...
/***/ "./node_modules/scenejs/dist/esm/utils/css.js":
/*!****************************************************!*\
  !*** ./node_modules/scenejs/dist/esm/utils/css.js ***!
  \****************************************************/
/*! exports provided: hasClass, addClass, removeClass, fromCSS */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ "./node_modules/scenejs/dist/esm/utils/dot.js":
/*!****************************************************!*\
  !*** ./node_modules/scenejs/dist/esm/utils/dot.js ***!
  \****************************************************/
/*! exports provided: dotArray, dotColor, dotObject, dot, dotValue */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "dotArray", function() { return dotArray; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "dotColor", function() { return dotColor; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "dotObject", function() { return dotObject; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "dot", function() { return dot; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "dotValue", function() { return dotValue; });
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utils */ "./node_modules/scenejs/dist/esm/utils.js");
/* harmony import */ var _PropertyObject__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../PropertyObject */ "./node_modules/scenejs/dist/esm/PropertyObject.js");
/**
* @namespace
...
function dotArray(a1, a2, b1, b2) {
    ...
    if (!Object(_utils__WEBPACK_IMPORTED_MODULE_0__["isArray"])(a2)) {
        return a1;
    }
...
function dotColor(color1, color2, b1, b2) {
    ...
    var object = new _PropertyObject__WEBPACK_IMPORTED_MODULE_1__["default"](v, {
        type: "color",
        model: colorModel,
        prefix: colorModel + "(",
        suffix: ")"
...
function dotObject(a1, a2, b1, b2) {
    ...
    return new _PropertyObject__WEBPACK_IMPORTED_MODULE_1__["default"](arr, {
        type: a1Type,
...
function dot(a1, a2, b1, b2) {
    ...
    // dot Object
    var type1 = Object(_utils__WEBPACK_IMPORTED_MODULE_0__["getType"])(a1);
    var type2 = Object(_utils__WEBPACK_IMPORTED_MODULE_0__["getType"])(a2);
    if (type1 === type2) {
        if (type1 === "property") {
    ...
    var r1 = b1 / (b1 + b2);
    var r2 = 1 - r1;
    var v1 = Object(_utils__WEBPACK_IMPORTED_MODULE_0__["splitUnit"])("" + a1);
    var v2 = Object(_utils__WEBPACK_IMPORTED_MODULE_0__["splitUnit"])("" + a2);
    var v;
...
/***/ "./node_modules/scenejs/dist/esm/utils/property.js":
/*!*********************************************************!*\
  !*** ./node_modules/scenejs/dist/esm/utils/property.js ***!
  \*********************************************************/
/*! exports provided: splitSpace, splitComma, splitStyle, arrayToColorObject, toColorObject, stringToBracketObject, arrayToPropertyObject, stringToColorObject, toPropertyObject, toObject */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "splitStyle", function() { return splitStyle; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "arrayToColorObject", function() { return arrayToColorObject; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "toColorObject", function() { return toColorObject; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "stringToBracketObject", function() { return stringToBracketObject; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "arrayToPropertyObject", function() { return arrayToPropertyObject; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "stringToColorObject", function() { return stringToColorObject; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "toPropertyObject", function() { return toPropertyObject; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "toObject", function() { return toObject; });
/* harmony import */ var _PropertyObject__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../PropertyObject */ "./node_modules/scenejs/dist/esm/PropertyObject.js");
/* harmony import */ var _color__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./color */ "./node_modules/scenejs/dist/esm/utils/color.js");
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../utils */ "./node_modules/scenejs/dist/esm/utils.js");
/**
* @namespace
* @name Property
...
function arrayToColorObject(arr) {
    ...
    return new _PropertyObject__WEBPACK_IMPORTED_MODULE_0__["default"](arr, {
        model: model,
        separator: ",",
        type: "color",
        prefix: model + "(",
...
function toColorObject(value) {
    var colorObject;
    if (value instanceof _PropertyObject__WEBPACK_IMPORTED_MODULE_0__["default"]) {
        colorObject = value;
    }
    else if (Object(_utils__WEBPACK_IMPORTED_MODULE_2__["isArray"])(value)) {
        colorObject = arrayToColorObject(value);
    }
    else if (Object(_utils__WEBPACK_IMPORTED_MODULE_2__["isString"])(value)) {
    ...
    switch (colorModel) {
        ...
        case "hsla":
            ...
            // hsl, hsla to rgba
            colorArray = Object(_color__WEBPACK_IMPORTED_MODULE_1__["hslToRGB"])(colorArray);
...
function stringToBracketObject(value) {
    ...
    if (obj instanceof _PropertyObject__WEBPACK_IMPORTED_MODULE_0__["default"]) {
    ...
    var result = new _PropertyObject__WEBPACK_IMPORTED_MODULE_0__["default"](values, {
        separator: separator,
        model: model,
        prefix: prefix,
        suffix: suffix
    });
    if (_color__WEBPACK_IMPORTED_MODULE_1__["COLOR_MODELS"].indexOf(model) !== -1) {
...
function stringToColorObject(value) {
    ...
    if (value.charAt(0) === "#") {
        if (value.length === 4) {
            colorArray = Object(_color__WEBPACK_IMPORTED_MODULE_1__["hexToRGB"])(Object(_color__WEBPACK_IMPORTED_MODULE_1__["hex3to6"])(value));
        }
        else {
            colorArray = Object(_color__WEBPACK_IMPORTED_MODULE_1__["hexToRGB"])(value);
        }
        return arrayToColorObject(colorArray);
    }
...
function toPropertyObject(value) {
    if (!Object(_utils__WEBPACK_IMPORTED_MODULE_2__["isString"])(value)) {
    ...
    if (values && values[1] === values[3]) {
        // Quotes
        return new _PropertyObject__WEBPACK_IMPORTED_MODULE_0__["default"]([toPropertyObject(values[2])], {
            prefix: values[1],
            suffix: values[1]
        });
    }
...
var App = /** @class */ (function (_super) {
    ...
    App.prototype.renderCircle = function (delay) {
        return React.createElement(react_scenejs_1.SceneItem, { from: { 'border-width': '150px', 'opacity': 1, 'transform': 'scale(0)' }, to: { 'border-width': '0px', 'opacity': 0.3, 'transform': 'scale(0.7)' }, delay: delay, duration: 1, easing: react_scenejs_1.easing.EASE_IN_OUT, iterationCount: 'infinite', autoplay: true, css: true, ref: function (e) {
                if (e) {
                    window['item' + delay] = e;
                }
            } },
    ...
    App.prototype.render = function () {
        ...
        var EASE_IN_OUT = react_scenejs_1.easing.EASE_IN_OUT;
        var keyframes = {
            0: { 'border-width': '150px', 'opacity': 1, 'transform': 'scale(0)' },
            1: { 'border-width': '0px', 'opacity': 0.3, 'transform': 'scale(0.7)' }
        };
        return React.createElement("div", { className: 'wrapper' },
            React.createElement(react_scenejs_1.Scene, { easing: EASE_IN_OUT, keyframes: {
            ...
            React.createElement("br", null),
            React.createElement(react_scenejs_1.Scene, { easing: EASE_IN_OUT, time: time + "%", keyframes: {
                    raindrop1: { keyframes: keyframes, options: { delay: 0 } },
                    raindrop2: { keyframes: keyframes, options: { delay: 0.4 } },
                    raindrop3: { keyframes: keyframes, options: { delay: 0.8 } },
                } },
...
Object.defineProperty(exports, "__esModule", { value: true });
var scenejs_1 = __webpack_require__(/*! scenejs */ "./node_modules/scenejs/dist/esm/index.js");
...
Object.defineProperty(exports, "__esModule", { value: true });
var scenejs_1 = __webpack_require__(/*! scenejs */ "./node_modules/scenejs/dist/esm/index.js");
exports.easing = scenejs_1.easing;
