...
(function (factory) {
	...
	*/
	...
	/*#__PURE__*/
	function (_super) {
	  __extends(Scene$1, _super);

	  function Scene$1() {
	    var _this = _super !== null && _super.apply(this, arguments) || this;

	    _this.item = new Scene({}, {
	      selector: true
	    });
	    return _this;
	  }
	...
	function (_super) {
	  ...
	  function App(props) {
	    ...
	    _this.keyframes = {
	      ...
	      ".clapper .stick1 .rect": function (i) {
	        return {
	          0: {
	            transform: {
	              scale: 0,
	      ...
	      ".clapper .stick2 .rect": function (i) {
	        return {
	          0: {
	            transform: {
	              scale: 0,
	  ...
	  __proto.render = function () {
	    ...
	    return h("div", {
	      ...
	      viewBox: "0 0 70 77.73502691896255"
	    }, h("path", {
	      ...
	      onAnimate: function (e) {
	        if (_this.inputEl) {
	          _this.inputEl.value = "" + 100 * e.time / e.currentTarget.getDuration();
	        }
	      },
	      onPlay: function () {
	        _this.playEl.className = "pause";
	      },
	      onPaused: function () {
	        _this.playEl.className = "play";
	      }
	    }, h("div", {
	      className: "circles"
	    }, h("div", {
	      ...
	      onClick: function (e) {
	        _this.scene.isPaused() ? _this.scene.play() : _this.scene.pause();
	      }
	    }), h("input", {
	      ref: function (e) {
	        _this.inputEl = e;
	      ...
	      onInput: function (e) {
	        ...
	        _this.scene.setTime(e.currentTarget.value + "%");
	      }
	    }))));
	  };
