 ...
 */
  ...
  */
		...
		value: function _getNowFrame(time, easing) {
			...
			var nextFrame = this.getFrame(0) || this.getFillFrame(0);
			var frame = this.newFrame();
			var names = this.timeline.names;
...
var Frame = function (_FrameWrapper) {
	...
	_createClass(Frame, [{
		...
		value: function toCSSObject() {
			...
			_consts.TRANSFORM && (cssObject[_consts.TRANSFORM] = transform);
			_consts.FILTER && (cssObject[_consts.FILTER] = filter);
