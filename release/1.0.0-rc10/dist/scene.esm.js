...
version: 1.0.0-rc10
*/
import { isObject, isArray, toArray, isString, $, document, IS_WINDOW, ANIMATION, removeEvent, addEvent, OBJECT, ARRAY, PROPERTY, STRING, NUMBER, splitComma, splitSpace, splitBracket, COLOR_MODELS, stringToRGBA, RGBA, requestAnimationFrame, cancelAnimationFrame, splitUnit, camelize, isUndefined, TRANSFORM, FILTER, FUNCTION, dot as dot$1, isFunction, fromCSS, KEYFRAMES, addClass, removeClass, hasClass, decamelize } from '@daybrush/utils';
...
export { SceneItem, Frame, Animator, OPTIONS, EVENTS, FIXED, ROLES, setRole, setAlias, bezier, steps, STEP_START, STEP_END, LINEAR, EASE, EASE_IN, EASE_OUT, EASE_IN_OUT, animate, animateItem };
