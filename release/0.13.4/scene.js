 ...
 */
  ...
  */
		...
		key: "animate",
		value: function animate(parentEasing, parent) {
...
var SceneItem = function (_SceneItemWrapper) {
	...
	_createClass(SceneItem, [{
		...
		key: "animate",
		value: function animate(parentEasing, parent) {
			var frame = _get(SceneItem.prototype.__proto__ || Object.getPrototypeOf(SceneItem.prototype), "animate", this).call(this, parentEasing, parent);
			var elements = this._elements;
