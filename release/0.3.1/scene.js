...
var _FrameTimeline = __webpack_require__(16);

var _FrameTimeline2 = _interopRequireDefault(_FrameTimeline);

var _dot = __webpack_require__(18);
 ...
 */
  ...
  */
		...
		key: "setTime",
		value: function setTime(time, easing) {
  ...
  */
		...
		value: function getNowValue(role, property, time) {
			...
			var ratio = easingFunction((time - startTime) / (endTime - startTime));
  ...
  frame.getProperty("opacity"); // 0.5
  	*/
		...
		value: function toCSS() {
			...
			var easingName = options.easing && options.easingName || this.state.easingName;
